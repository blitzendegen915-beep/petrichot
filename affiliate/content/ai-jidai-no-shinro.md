...
最も重要なのは、AIに競争で負けるのではなく、「AIを使いこなす側」になることです。まずは[AIが何かを理解する](https://petrichot.com/ai-toha-nani/)ことから始めましょう。
...
- これらは、実は進路・職業決定の時点で、大きなアドバンテージになります。[勉強にAIを正しく活用する方法](https://petrichot.com/benkyou-ni-ai-wo-tsukau-houhou/)を知ることで、学習が効率化します。
...
**それは何か：**
- 誰かの気持ちに寄り添うこと：親友がつらいとき、AIは正論を言うかもしれませんが、友人のあなただからこそ相手は安心します
...
**パターン2：新しいテクノロジーに興味がある場合は、「AIと共存する職業」につながる分野を学ぶ**
- プログラミング、データ分析、AIの倫理を考える職業など

こうした進路に興味があるなら、実際にコードを書きながらAIの支援を体験できるGitHub Copilotのようなツールに早いうちから触れてみるのもおすすめです。[プログラミング学習にAIを活用する方法](https://petrichot.com/programming-gakushuu-to-ai/)を学べば、より実践的なスキルが身につきます。
