...
フェイク情報と言っても、さまざまな形態があります。自分たちに関わる主なものを知っておくことが、最初の防衛線になります。ちなみに、SNSのおすすめ機能もAIが動かしており、[AIアルゴリズムがどのように情報を選別するか](https://petrichot.com/ai-to-sns-algorithm/)を理解することは、フェイク情報に立ち向かう上で大切です。
...
- 逆に、1つのSNSアカウントだけが言っていることは、疑ってかかる価値があります

こうした確認作業には、回答のもとになった情報源を提示してくれるPerplexityのようなAI検索ツール、または検索連動型のAIを使うと、出典をたどりやすくなります。
...
AIが進化しても、私たち人間の「思考する力」がなくなることはありません。むしろ、情報を無批判に受け入れるのではなく、「これは本当か」「誰が言ってるのか」「自分はどう思うか」を考える習慣がますます重要になります。このような判断力を鍛えることは、[AIリテラシーの基本を知る](https://petrichot.com/ai-riteracy-nyuumon/)ことにもつながっていきます。また、AIがもっともらしい嘘をつく仕組みについて、より詳しく知りたい人は、[AIのハルシネーションについての解説記事](https://petrichot.com/ai-hallucination-naze/)も参考になります。
