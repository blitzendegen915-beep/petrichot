...
SNS（Instagram、TikTok、YouTube）のおすすめ機能は、すべてAIで決まっています。[AIとは何かをより基本から理解したい](https://petrichot.com/ai-toha-nani/)人は、そちらも参考になります。
...
AIが「あなたの好きそうな情報」ばかり流すことで、思わぬ弊害が生まれます。それが「フィルターバブル」です。このような現象は、[フェイク情報の広がりやすさ](https://petrichot.com/ai-fake-joho-mimawake/)と密接に関連しています。
...
これらを意識することで、SNSを有効に活用しながらも、自分の視点を広く保つことができるようになります。このような[AIリテラシーの基本を身につけること](https://petrichot.com/ai-riteracy-nyuumon/)は、情報社会を生きる上で非常に重要です。
